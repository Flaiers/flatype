  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      function l(t, e) {
        ...
        return (
          ...
          (e = (0, j["default"])(!0, {}, S.DEFAULTS, { modules: o }, n, e)),
        ...
        (s.prototype.eachLine = function (t, e) {
          ...
          for (var n = l.iterator(this.ops), r = new s(); n.hasNext(); ) {
            ...
            a < 0
              ...
              : a > 0
              ? r.push(n.next(a))
              : (t(r, n.next(1).attributes || {}), (r = new s()));
          }
          r.length() > 0 && t(r, {});
        }),
    ...
    function (t, e) {
      ...
      function o(t, e) {
        ...
        (s[l + 1] = 0), (u[l + 1] = 0);
        for (
          var f = n - r, p = f % 2 != 0, y = 0, v = 0, b = 0, g = 0, m = 0;
          m < o;
          m++
        ) {
      ...
      function s(t, e) {
        ...
        var c, f, p, h;
        t.length > e.length
          ? ((c = i[0]), (f = i[1]), (p = i[2]), (h = i[3]))
          : ((p = i[0]), (h = i[1]), (c = i[2]), (f = i[3]));
        var d = i[4];
        return [c, f, p, h, d];
      }
      function u(t) {
            ...
            case y:
              r + o > 1
                ? (0 !== r &&
                    ...
                    ((e = l(s, i)),
                    0 !== e &&
                      (n - r - o > 0 && t[n - r - o - 1][0] == y
                        ? (t[n - r - o - 1][1] += s.substring(0, e))
                        : (t.splice(0, 0, [y, s.substring(0, e)]), n++),
                      (s = s.substring(e)),
                      (i = i.substring(e))),
                    (e = a(s, i)),
                    0 !== e &&
                  ...
                  0 === r
                    ? t.splice(n - o, r + o, [d, s])
                    : 0 === o
                    ? t.splice(n - r, r + o, [h, i])
                    : t.splice(n - r - o, r + o, [h, i], [d, s]),
            ...
            c(t, [
              ...
              },
              {
                ...
                value: function (t, e, n) {
                  return (
                    ...
                    this.update(
                      new p["default"]().retain(t).insert(o({}, e, n))
                    )
                  );
                },
              },
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return (
                    1 === n.length &&
                    "characterData" === n[0].type &&
                    v["default"].find(n[0].target)
                      ? !(function () {
                          var i = v["default"].find(n[0].target),
                            l = (0, O.bubbleFormats)(i),
                            a = i.offset(e.scroll),
                            s = n[0].oldValue.replace(
                              _["default"].CONTENTS,
                              ""
                            ),
                      ...
                      : ((this.delta = this.getDelta()),
                        (t && (0, j["default"])(o.compose(t), this.delta)) ||
                          (t = o.diff(this.delta, r))),
                    t
                  );
                },
              },
            ...
            [
              ...
              },
              {
                ...
                value: function (t, n, r, o) {
                  if (
                    0 !== n &&
                    null != h["default"].query(r, h["default"].Scope.BLOCK) &&
              ...
              [
                {
                  ...
                  value: function (t, n, r, o) {
                    if (
                      ...
                      d["default"].query(r, d["default"].Scope.BLOT)
                    ) {
                    ...
                    this.remove(),
                      null != i &&
                        this.selection.emitter.once(
                          b["default"].events.SCROLL_OPTIMIZE,
                          function () {
          ...
          function a(e, r) {
            ...
            if (e instanceof l) c = new l();
              ...
              if (h && Buffer.isBuffer(e))
                return (c = new Buffer(e.length)), e.copy(c), c;
              "undefined" == typeof o
                ? ((d = Object.getPrototypeOf(e)), (c = Object.create(d)))
                : ((c = Object.create(o)), (d = o));
            }
            if (n) {
              var y = f.indexOf(e);
              if (y != -1) return p[y];
            ...
            if (Object.getOwnPropertySymbols)
              for (
                var k = Object.getOwnPropertySymbols(e), w = 0;
                w < k.length;
                w++
              ) {
                var E = k[w];
                    ...
                    if (null != e) {
                      ...
                      if (window.innerHeight < i) {
                        ...
                        document.documentElement.scrollTop =
                          c.domNode.offsetTop +
                          c.domNode.offsetHeight +
                          r -
                          window.innerHeight +
                          l;
                      } else if (o < 0) {
                        var f = this.scroll.line(
                            Math.min(t.index, this.scroll.length() - 1)
                          ),
                          p = a(f, 1),
                          h = p[0];
                        document.documentElement.scrollTop =
                          h.domNode.offsetTop + r - l;
                      }
                    }
                  }
                },
                ...
                value: function (t, n, r) {
                  if (
                    ...
                    if (t >= this.length())
                      if (
                        null == r ||
                        null == p["default"].query(n, p["default"].Scope.BLOCK)
                      ) {
                    ...
                    n = function r(t, e, n) {
                      ...
                      return (
                        t.children.forEachAt(e, n, function (t, e, n) {
                          a(t)
                            ? o.push(t)
                            : t instanceof p["default"].Container &&
                              (o = o.concat(r(t, e, i))),
                            (i -= n);
                        }),
                        o
    ...
    function (t, e, n) {
          ...
          n
            ...
            .forEach(function (e) {
              ...
              (null != n && ((i[n.attrName] = n.value(t)), i[n.attrName])) ||
                ...
                null != F[e] && ((n = F[e]), (i[n.attrName] = n.value(t))));
            }),
      ...
      function g(t, e) {
        if (f(t) && null != t.nextElementSibling && !c(e, "\n\n")) {
          ...
          t.nextElementSibling.offsetTop > t.offsetTop + 1.5 * i &&
            e.insert("\n");
        }
        return e;
      }
                    ...
                    var n,
                      ...
                      s = function (t) {
                        e.container.focus(),
                          ...
                          e.quill.emitter.emit(
                            e.quill.emitter.constructor.events.TEXT_PASTE,
                            i,
                            N["default"].sources.USER
                          );
                      };
                    if (
                      "undefined" != typeof t.clipboardData &&
                      (n = t.clipboardData.items)
                    )
                      for (var u = 0; u < n.length; u++)
                        if (
                          "file" == n[u].kind &&
                          0 == n[u].type.indexOf("image/")
                        ) {
                          var c = n[u].getAsFile();
                          e.quill.updatePhoto(c, function (t) {
                            if (
                              e.quill.fileSizeLimit &&
                              t.size > e.quill.fileSizeLimit
                            )
                              return void (
                                e.quill.fileSizeLimitCallback &&
                                e.quill.fileSizeLimitCallback()
                              );
    ...
    function (t, e, n) {
      ...
      var a = (function () {
        ...
        h = new f("color", "color", { scope: c["default"].Scope.INLINE });
              ...
              r.quill.on(
                ...
                function (t, e, n, o) {
                  t !== h["default"].events.TEXT_CHANGE ||
                    r.ignoreChange ||
                    (r.options.userOnly && o !== h["default"].sources.USER
                      ? r.transform(e)
                      : r.record(e, n));
                }
              ),
    ...
    function (t, e, n) {
      ...
      function s(t) {
        t.index >= this.quill.getLength() - 1 ||
          this.quill.deleteText(t.index, 1, N["default"].sources.USER);
      }
      function u(t) {
      ...
      function c(t, e) {
        ...
        var r = Object.keys(e.format).reduce(function (t, n) {
          return (
            j["default"].query(n, j["default"].Scope.BLOCK) &&
          ...
          Object.keys(e.format).forEach(function (t) {
            null == r[t] &&
              (Array.isArray(e.format[t]) ||
                ("link" !== t &&
                  n.quill.format(t, e.format[t], N["default"].sources.USER)));
          });
      }
      function f(t) {
        return {
        ...
        M = (function (t) {
          function e(t, n) {
            ...
            return (
              ...
              r.addBinding({ key: e.keys.ENTER, shiftKey: null }, c),
              r.addBinding(
                {
                  key: e.keys.ENTER,
                  metaKey: null,
              ...
              r.addBinding({ key: e.keys.BACKSPACE }, { collapsed: !1 }, u),
              r.addBinding({ key: e.keys.DELETE }, { collapsed: !1 }, u),
              /Trident/i.test(navigator.userAgent) &&
                (r.addBinding({ key: e.keys.BACKSPACE, shortKey: !0 }, a),
                r.addBinding({ key: e.keys.DELETE, shortKey: !0 }, s)),
              r.listen(),
              r
            );
          }
            ...
            v(e, null, [
              {
                ...
                value: function (t, e) {
                  return (
                    (e = h(e)),
                    (!!e.shortKey === t[C] || null === e.shortKey) &&
            ...
            v(e, [
              {
                ...
                value: function (t) {
                  ...
                  return null == r || null == r.key
                    ? L.warn("Attempted to add invalid keyboard binding", r)
                      ...
                      if (0 !== o.length) {
                        ...
                        if (null != i && t.quill.hasFocus()) {
                          var l = t.quill.scroll.line(i.index),
                            ...
                            m = b[1],
                            O =
                              p instanceof j["default"].Text
                                ? p.value().slice(0, h)
                                : "",
                            w =
                              g instanceof j["default"].Text
                                ? g.value().slice(m)
                                : "",
                            x = {
      ...
      var g = new c["default"].Attributor.Class("token", "hljs", {
        ...
        m = (function (t) {
          function e(t, n) {
            ...
            var l = null;
            return (
              r.quill.on(p["default"].events.SCROLL_OPTIMIZE, function () {
                null == l &&
                ...
                value: function () {
                  ...
                  if (!this.quill.selection.composing) {
                    ...
                    this.quill.scroll.descendants(b).forEach(function (e) {
                      ...
                      null != e &&
                        this.quill.setSelection(e, p["default"].sources.SILENT);
                  }
                },
              },
            ]),
    ...
    function (t, e, n) {
      "use strict";
      t.exports = {
        align: { "": n(70), center: n(71), right: n(72), justify: n(73) },
        background: n(74),
        blockquote: n(75),
        bold: n(76),
        clean: n(77),
        ...
        float: { center: n(82), full: n(83), left: n(84), right: n(85) },
        formula: n(86),
        header: { 1: n(87), 2: n(88) },
        italic: n(89),
        image: n(90),
        indent: { "+1": n(91), "-1": n(92) },
        link: n(93),
        list: { ordered: n(94), bullet: n(95) },
        script: { sub: n(96), super: n(97) },
        strike: n(98),
        underline: n(99),
        video: n(100),
      };
    ...
    function (t, e, n) {
      ...
      var g = (function (t) {
        function e(t, n) {
          ...
          return (
            r.quill.on(p["default"].events.EDITOR_CHANGE, function (t, e) {
                    ...
                    if (
                      ...
                      return (
                        null == t.querySelector("option") &&
                          a(t, P, "background" === e ? "#ffffff" : "#000000"),
                  ...
                  e.addEventListener("change", function () {
                    if (null != e.files && null != e.files[0]) {
                      ...
                      t.quill.updatePhoto(n, function (n) {
                        if (
                          t.quill.fileSizeLimit &&
                          n.size > t.quill.fileSizeLimit
                        )
                          return void (
                            t.quill.fileSizeLimitCallback &&
                            t.quill.fileSizeLimitCallback()
                          );
