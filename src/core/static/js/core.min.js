...
function getFigureValueByUrl(t) {
  ...
  if (
    ...
    return {
      embed: "https://telegra.ph/embed/youtube?url=" + encodeURIComponent(t),
    };
  if ((e = t.match(/^(https?):\/\/(www\.)?vimeo\.com\/(\d+)/i)))
    return {
      embed: "https://telegra.ph/embed/vimeo?url=" + encodeURIComponent(t),
    };
  if (
    (e = t.match(
    ...
    return {
      embed: "https://telegra.ph/embed/twitter?url=" + encodeURIComponent(t),
    };
  if (
    (e = t.match(
    ...
    return {
      embed: "https://telegra.ph/embed/telegram?url=" + encodeURIComponent(t),
    };
  if (
    (e = t.match(
